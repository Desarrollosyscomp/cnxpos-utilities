  ...
  <div class="container">
    <div class="home-content">
      ...
      <div class="options">
        ...
        <div class="item">
          <Icon :path="mdiCurrencyUsd" class="icon" @click="router.push('/web-report-v2/daily-sales')"/>
...
.bubble-a.bubble {
  ...
  --triangle-y: calc(60px * var(--beto-proportion));
...
.beto-content {
  line-height: calc(28px * var(--beto-proportion));
  text-align: center;
  padding: calc(10px * var(--beto-proportion));
  display: flex;
